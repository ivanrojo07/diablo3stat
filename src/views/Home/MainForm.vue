            ...
            <div class="col-12 col-md-8 offset-md-2">
                ...
                <b-form @submit.prevent="onSubmit">
                    <b-form-group id="input-group-1" label="BattleTag:" label-for="input-text" description="Format: YourProfile#1234">
                        <b-form-input v-focus class="form-input" id="input-text" v-model="form.battleTag" type="text" size="lg" required="required" placeholder="BattleTag" />
                    </b-form-group>
                    <b-form-group id="input-group-3" label="Region:" labe-for="input-region">
                        <b-form-select id="input-region" v-model="form.region" size="lg" :options="regions" required="required" />
                    </b-form-group>
